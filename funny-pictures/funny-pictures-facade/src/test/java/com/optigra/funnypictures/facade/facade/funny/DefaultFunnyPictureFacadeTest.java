...
import com.optigra.funnypictures.facade.converter.funny.FunnyPictureResourceConverter;
import com.optigra.funnypictures.facade.converter.tag.TagConverter;
...
public class DefaultFunnyPictureFacadeTest {
	...
	@Mock
	private FunnyPictureResourceConverter funnyPictureResourceConverter;
	...
	public void testCreateFunnyPicture() throws Exception {
		...
		when(funnyPictureResourceConverter.convert(any(FunnyPictureResource.class))).thenReturn(new FunnyPicture());
