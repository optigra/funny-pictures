                ...
                server: {
                    ...
                    files: {
                        ...
                        '<%= app.dist %>/js/app.js': [
                            ...
                            '<%= app.source %>/js/blocks/exception/exception.module.js',
                            '<%= app.source %>/js/blocks/exception/exception.factory.js',

                            '<%= app.source %>/js/blocks/logger/logger.module.js',
                            '<%= app.source %>/js/blocks/logger/logger.factory.js',
