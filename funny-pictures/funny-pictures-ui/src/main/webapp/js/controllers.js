...
funnyControllers.controller('CreatePictureController', ['$scope', '$location', '$window', 'FileUpload', 'SharedProperties', 'Pictures', function ($scope, $location, $window, FileUpload, SharedProperties, Pictures) {
    $scope.pictureTitle = "";
    $scope.headerText = "";
