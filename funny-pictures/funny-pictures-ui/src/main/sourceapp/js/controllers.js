...
funnyControllers.controller('PreviewFunnyController', [
    ...
    'apiUrl',
    'Funnies',
    function($scope, $routeParams, $http, $location, $window, $mdToast, apiUrl, Funnies) {
        $scope.funnyPicture = {};
...
funnyControllers.controller('CreatePictureController', [
    ...
    'apiUrl',
    'Pictures',
    function($scope, $location, $window, $mdToast, FileUpload, apiUrl,
        Pictures) {
        $scope.pictureTitle = "";
        $scope.pictureUrl = "";
...
funnyControllers.controller('CreateFunnyPictureController', [
    ...
    'Pictures',
    'Funnies',
    function($scope, $routeParams, $window, $http, $mdDialog, $mdToast, apiUrl, Pictures,
        Funnies) {
        $scope.template = {};
        $scope.funnyPicture = {};
        $scope.funniesByTemplate = {};
