...
funnyControllers.controller('FunniesController', ['$scope', '$mdDialog', '$mdToast',
    'FunnyPicturesThumbnails',
    function($scope, $mdDialog, $mdToast, FunnyPicturesThumbnails) {
        $scope.funnies = {};
        $scope.currentPage = 1;
        $scope.totalItems = 0;
        $scope.itemsPerPage = 8;
...
funnyControllers.controller('FunnyPreviewModalController', ['$scope',
    '$window', '$mdDialog', 'funnyThumbnail', 'Funnies',
    function($scope, $window, $mdDialog, funnyThumbnail, Funnies) {
...
funnyControllers.controller('CreateFunnyPictureController', [
    ...
    'Pictures',
    'Funnies',
    function($scope, $window, $http, $mdDialog, $mdToast, SharedProperties, Pictures,
        Funnies) {
        $scope.template = {};
